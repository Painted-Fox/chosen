module.exports = (grunt) ->
  ...
  grunt.initConfig
    ...
    comments: """
/*!
A fork of Chosen to support an alternate user interface
by Ryan Seto <ryan.seto@yak.net>, for Connect Healthcare.

Chosen is originally by Patrick Filler for Harvest, http://getharvest.com

Version <%= pkg.version %>
Source code: https://github.com/Painted-Fox/chosen
Original source: https://github.com/harvesthq/chosen
Fork Copyright (c) 2014-<%= grunt.template.today('yyyy') %> Connect Healthcare http://connecthealthcare.com
Original Copyright (c) 2011-<%= grunt.template.today('yyyy') %> Harvest http://getharvest.com
